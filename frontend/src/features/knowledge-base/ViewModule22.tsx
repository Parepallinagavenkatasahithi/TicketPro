...
export interface KnowledgeBaseItem22 {
  id: number;
  code: string;
  name: string;
  category: string;
...
interface KnowledgeBaseViewModule22Props {
  title?: string;
  onItemSelect?: (item: KnowledgeBaseItem22) => void;
}

export const KnowledgeBaseViewModule22: React.FC<KnowledgeBaseViewModule22Props> = ({
  title = "Knowledge Base & Documentation Component 22",
  onItemSelect
}) => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedStatus, setSelectedStatus] = useState<string>('ALL');

  const mockData: KnowledgeBaseItem22[] = [
    { id: 101, code: "KNO-22-001", name: "Knowledge Base & Documentation Record A", category: "ENTERPRISE", status: "ACTIVE", priority: "HIGH", created_at: "2026-09-01T10:00:00Z" },
    { id: 102, code: "KNO-22-002", name: "Knowledge Base & Documentation Record B", category: "STANDARD", status: "PENDING", priority: "MEDIUM", created_at: "2026-09-02T14:30:00Z" },
    { id: 103, code: "KNO-22-003", name: "Knowledge Base & Documentation Record C", category: "CRITICAL", status: "IN_REVIEW", priority: "CRITICAL", created_at: "2026-09-03T09:15:00Z" }
  ];
