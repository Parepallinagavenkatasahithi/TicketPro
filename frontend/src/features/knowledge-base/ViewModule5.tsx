...
export interface KnowledgeBaseItem5 {
  id: number;
  code: string;
  name: string;
  category: string;
...
interface KnowledgeBaseViewModule5Props {
  title?: string;
  onItemSelect?: (item: KnowledgeBaseItem5) => void;
}

export const KnowledgeBaseViewModule5: React.FC<KnowledgeBaseViewModule5Props> = ({
  title = "Knowledge Base & Documentation Component 5",
  onItemSelect
}) => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedStatus, setSelectedStatus] = useState<string>('ALL');

  const mockData: KnowledgeBaseItem5[] = [
    { id: 101, code: "KNO-5-001", name: "Knowledge Base & Documentation Record A", category: "ENTERPRISE", status: "ACTIVE", priority: "HIGH", created_at: "2026-09-01T10:00:00Z" },
    { id: 102, code: "KNO-5-002", name: "Knowledge Base & Documentation Record B", category: "STANDARD", status: "PENDING", priority: "MEDIUM", created_at: "2026-09-02T14:30:00Z" },
    { id: 103, code: "KNO-5-003", name: "Knowledge Base & Documentation Record C", category: "CRITICAL", status: "IN_REVIEW", priority: "CRITICAL", created_at: "2026-09-03T09:15:00Z" }
  ];
