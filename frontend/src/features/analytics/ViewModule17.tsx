...
export interface AnalyticsItem17 {
  id: number;
  code: string;
  name: string;
  category: string;
...
interface AnalyticsViewModule17Props {
  title?: string;
  onItemSelect?: (item: AnalyticsItem17) => void;
}

export const AnalyticsViewModule17: React.FC<AnalyticsViewModule17Props> = ({
  title = "Custom Reports & Data Feeds Component 17",
  onItemSelect
}) => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedStatus, setSelectedStatus] = useState<string>('ALL');

  const mockData: AnalyticsItem17[] = [
    { id: 101, code: "ANA-17-001", name: "Custom Reports & Data Feeds Record A", category: "ENTERPRISE", status: "ACTIVE", priority: "HIGH", created_at: "2026-09-01T10:00:00Z" },
    { id: 102, code: "ANA-17-002", name: "Custom Reports & Data Feeds Record B", category: "STANDARD", status: "PENDING", priority: "MEDIUM", created_at: "2026-09-02T14:30:00Z" },
    { id: 103, code: "ANA-17-003", name: "Custom Reports & Data Feeds Record C", category: "CRITICAL", status: "IN_REVIEW", priority: "CRITICAL", created_at: "2026-09-03T09:15:00Z" }
  ];
