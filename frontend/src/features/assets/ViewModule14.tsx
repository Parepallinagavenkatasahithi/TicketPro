...
interface AssetViewModule14Props {
  title?: string;
  onItemSelect?: (item: AssetItem14) => void;
}

export const AssetViewModule14: React.FC<AssetViewModule14Props> = ({
  title = "IT Asset Inventory & CMDB Component 14",
  onItemSelect
}) => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedStatus, setSelectedStatus] = useState<string>('ALL');

  const mockData: AssetItem14[] = [
    { id: 101, code: "ASS-14-001", name: "IT Asset Inventory & CMDB Record A", category: "ENTERPRISE", status: "ACTIVE", priority: "HIGH", created_at: "2026-09-01T10:00:00Z" },
    { id: 102, code: "ASS-14-002", name: "IT Asset Inventory & CMDB Record B", category: "STANDARD", status: "PENDING", priority: "MEDIUM", created_at: "2026-09-02T14:30:00Z" },
    { id: 103, code: "ASS-14-003", name: "IT Asset Inventory & CMDB Record C", category: "CRITICAL", status: "IN_REVIEW", priority: "CRITICAL", created_at: "2026-09-03T09:15:00Z" }
  ];
