...
interface AssetViewModule30Props {
  title?: string;
  onItemSelect?: (item: AssetItem30) => void;
}

export const AssetViewModule30: React.FC<AssetViewModule30Props> = ({
  title = "IT Asset Inventory & CMDB Component 30",
  onItemSelect
}) => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedStatus, setSelectedStatus] = useState<string>('ALL');

  const mockData: AssetItem30[] = [
    { id: 101, code: "ASS-30-001", name: "IT Asset Inventory & CMDB Record A", category: "ENTERPRISE", status: "ACTIVE", priority: "HIGH", created_at: "2026-09-01T10:00:00Z" },
    { id: 102, code: "ASS-30-002", name: "IT Asset Inventory & CMDB Record B", category: "STANDARD", status: "PENDING", priority: "MEDIUM", created_at: "2026-09-02T14:30:00Z" },
    { id: 103, code: "ASS-30-003", name: "IT Asset Inventory & CMDB Record C", category: "CRITICAL", status: "IN_REVIEW", priority: "CRITICAL", created_at: "2026-09-03T09:15:00Z" }
  ];
