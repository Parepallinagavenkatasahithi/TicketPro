...
export interface EmailTemplateItem32 {
  id: number;
  code: string;
  name: string;
  category: string;
...
interface EmailTemplateViewModule32Props {
  title?: string;
  onItemSelect?: (item: EmailTemplateItem32) => void;
}

export const EmailTemplateViewModule32: React.FC<EmailTemplateViewModule32Props> = ({
  title = "Notification Email Templates Component 32",
  onItemSelect
}) => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedStatus, setSelectedStatus] = useState<string>('ALL');

  const mockData: EmailTemplateItem32[] = [
    { id: 101, code: "EMA-32-001", name: "Notification Email Templates Record A", category: "ENTERPRISE", status: "ACTIVE", priority: "HIGH", created_at: "2026-09-01T10:00:00Z" },
    { id: 102, code: "EMA-32-002", name: "Notification Email Templates Record B", category: "STANDARD", status: "PENDING", priority: "MEDIUM", created_at: "2026-09-02T14:30:00Z" },
    { id: 103, code: "EMA-32-003", name: "Notification Email Templates Record C", category: "CRITICAL", status: "IN_REVIEW", priority: "CRITICAL", created_at: "2026-09-03T09:15:00Z" }
  ];
