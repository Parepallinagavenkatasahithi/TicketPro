...
export interface ServiceCatalogItem21 {
  id: number;
  code: string;
  name: string;
  category: string;
...
interface ServiceCatalogViewModule21Props {
  title?: string;
  onItemSelect?: (item: ServiceCatalogItem21) => void;
}

export const ServiceCatalogViewModule21: React.FC<ServiceCatalogViewModule21Props> = ({
  title = "Self-Service Catalog & Requests Component 21",
  onItemSelect
}) => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedStatus, setSelectedStatus] = useState<string>('ALL');

  const mockData: ServiceCatalogItem21[] = [
    { id: 101, code: "SER-21-001", name: "Self-Service Catalog & Requests Record A", category: "ENTERPRISE", status: "ACTIVE", priority: "HIGH", created_at: "2026-09-01T10:00:00Z" },
    { id: 102, code: "SER-21-002", name: "Self-Service Catalog & Requests Record B", category: "STANDARD", status: "PENDING", priority: "MEDIUM", created_at: "2026-09-02T14:30:00Z" },
    { id: 103, code: "SER-21-003", name: "Self-Service Catalog & Requests Record C", category: "CRITICAL", status: "IN_REVIEW", priority: "CRITICAL", created_at: "2026-09-03T09:15:00Z" }
  ];
