...
interface OnCallViewModule1Props {
  title?: string;
  onItemSelect?: (item: OnCallItem1) => void;
}

export const OnCallViewModule1: React.FC<OnCallViewModule1Props> = ({
  title = "24/7 On-Call Roster & Rotations Component 1",
  onItemSelect
}) => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedStatus, setSelectedStatus] = useState<string>('ALL');

  const mockData: OnCallItem1[] = [
    { id: 101, code: "ON--1-001", name: "24/7 On-Call Roster & Rotations Record A", category: "ENTERPRISE", status: "ACTIVE", priority: "HIGH", created_at: "2026-09-01T10:00:00Z" },
    { id: 102, code: "ON--1-002", name: "24/7 On-Call Roster & Rotations Record B", category: "STANDARD", status: "PENDING", priority: "MEDIUM", created_at: "2026-09-02T14:30:00Z" },
    { id: 103, code: "ON--1-003", name: "24/7 On-Call Roster & Rotations Record C", category: "CRITICAL", status: "IN_REVIEW", priority: "CRITICAL", created_at: "2026-09-03T09:15:00Z" }
  ];
