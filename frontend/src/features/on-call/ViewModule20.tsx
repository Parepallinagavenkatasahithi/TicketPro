...
interface OnCallViewModule20Props {
  title?: string;
  onItemSelect?: (item: OnCallItem20) => void;
}

export const OnCallViewModule20: React.FC<OnCallViewModule20Props> = ({
  title = "24/7 On-Call Roster & Rotations Component 20",
  onItemSelect
}) => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedStatus, setSelectedStatus] = useState<string>('ALL');

  const mockData: OnCallItem20[] = [
    { id: 101, code: "ON--20-001", name: "24/7 On-Call Roster & Rotations Record A", category: "ENTERPRISE", status: "ACTIVE", priority: "HIGH", created_at: "2026-09-01T10:00:00Z" },
    { id: 102, code: "ON--20-002", name: "24/7 On-Call Roster & Rotations Record B", category: "STANDARD", status: "PENDING", priority: "MEDIUM", created_at: "2026-09-02T14:30:00Z" },
    { id: 103, code: "ON--20-003", name: "24/7 On-Call Roster & Rotations Record C", category: "CRITICAL", status: "IN_REVIEW", priority: "CRITICAL", created_at: "2026-09-03T09:15:00Z" }
  ];
