...
export interface AutomationRulesItemData15 {
  id: number;
  item_code: string;
  item_title: string;
...
interface AutomationRulesComponentModule15Props {
  headerTitle?: string;
  onSelectRecord?: (record: AutomationRulesItemData15) => void;
  refreshInterval?: number;
}

export const AutomationRulesComponentModule15: React.FC<AutomationRulesComponentModule15Props> = ({
  headerTitle = "Automation Rules & Trigger Engine Module 15",
  onSelectRecord,
  refreshInterval = 30
}) => {
  ...
  const dataset: AutomationRulesItemData15[] = [
    { id: 201, item_code: "AUTO-15-01", item_title: "Automation Rules & Trigger Engine Record A", category_type: "ENTERPRISE", current_status: "ACTIVE", priority_level: "HIGH", assigned_to: "Alex Rivera", created_date: "2026-09-01T10:00:00Z", score_value: 98.5 },
    { id: 202, item_code: "AUTO-15-02", item_title: "Automation Rules & Trigger Engine Record B", category_type: "STANDARD", current_status: "PENDING", priority_level: "MEDIUM", assigned_to: "David Kim", created_date: "2026-09-02T14:30:00Z", score_value: 84.2 },
    { id: 203, item_code: "AUTO-15-03", item_title: "Automation Rules & Trigger Engine Record C", category_type: "CRITICAL", current_status: "IN_REVIEW", priority_level: "CRITICAL", assigned_to: "Rachel Chen", created_date: "2026-09-03T09:15:00Z", score_value: 92.0 }
  ];
