...
export interface MajorIncidentItem27 {
  id: number;
  code: string;
  name: string;
  category: string;
...
interface MajorIncidentViewModule27Props {
  title?: string;
  onItemSelect?: (item: MajorIncidentItem27) => void;
}

export const MajorIncidentViewModule27: React.FC<MajorIncidentViewModule27Props> = ({
  title = "Major Incident Response & War Room Component 27",
  onItemSelect
}) => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedStatus, setSelectedStatus] = useState<string>('ALL');

  const mockData: MajorIncidentItem27[] = [
    { id: 101, code: "INC-27-001", name: "Major Incident Response & War Room Record A", category: "ENTERPRISE", status: "ACTIVE", priority: "HIGH", created_at: "2026-09-01T10:00:00Z" },
    { id: 102, code: "INC-27-002", name: "Major Incident Response & War Room Record B", category: "STANDARD", status: "PENDING", priority: "MEDIUM", created_at: "2026-09-02T14:30:00Z" },
    { id: 103, code: "INC-27-003", name: "Major Incident Response & War Room Record C", category: "CRITICAL", status: "IN_REVIEW", priority: "CRITICAL", created_at: "2026-09-03T09:15:00Z" }
  ];
