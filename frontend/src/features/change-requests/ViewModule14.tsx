...
export interface ChangeRequestItem14 {
  id: number;
  code: string;
  name: string;
  category: string;
...
interface ChangeRequestViewModule14Props {
  title?: string;
  onItemSelect?: (item: ChangeRequestItem14) => void;
}

export const ChangeRequestViewModule14: React.FC<ChangeRequestViewModule14Props> = ({
  title = "Change Advisory Board Workflows Component 14",
  onItemSelect
}) => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedStatus, setSelectedStatus] = useState<string>('ALL');

  const mockData: ChangeRequestItem14[] = [
    { id: 101, code: "CHA-14-001", name: "Change Advisory Board Workflows Record A", category: "ENTERPRISE", status: "ACTIVE", priority: "HIGH", created_at: "2026-09-01T10:00:00Z" },
    { id: 102, code: "CHA-14-002", name: "Change Advisory Board Workflows Record B", category: "STANDARD", status: "PENDING", priority: "MEDIUM", created_at: "2026-09-02T14:30:00Z" },
    { id: 103, code: "CHA-14-003", name: "Change Advisory Board Workflows Record C", category: "CRITICAL", status: "IN_REVIEW", priority: "CRITICAL", created_at: "2026-09-03T09:15:00Z" }
  ];
