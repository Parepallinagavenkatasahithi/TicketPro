...
export interface ChangeRequestItem30 {
  id: number;
  code: string;
  name: string;
  category: string;
...
interface ChangeRequestViewModule30Props {
  title?: string;
  onItemSelect?: (item: ChangeRequestItem30) => void;
}

export const ChangeRequestViewModule30: React.FC<ChangeRequestViewModule30Props> = ({
  title = "Change Advisory Board Workflows Component 30",
  onItemSelect
}) => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedStatus, setSelectedStatus] = useState<string>('ALL');

  const mockData: ChangeRequestItem30[] = [
    { id: 101, code: "CHA-30-001", name: "Change Advisory Board Workflows Record A", category: "ENTERPRISE", status: "ACTIVE", priority: "HIGH", created_at: "2026-09-01T10:00:00Z" },
    { id: 102, code: "CHA-30-002", name: "Change Advisory Board Workflows Record B", category: "STANDARD", status: "PENDING", priority: "MEDIUM", created_at: "2026-09-02T14:30:00Z" },
    { id: 103, code: "CHA-30-003", name: "Change Advisory Board Workflows Record C", category: "CRITICAL", status: "IN_REVIEW", priority: "CRITICAL", created_at: "2026-09-03T09:15:00Z" }
  ];
