...
export interface ChangeRequestItem4 {
  id: number;
  code: string;
  name: string;
  category: string;
...
interface ChangeRequestViewModule4Props {
  title?: string;
  onItemSelect?: (item: ChangeRequestItem4) => void;
}

export const ChangeRequestViewModule4: React.FC<ChangeRequestViewModule4Props> = ({
  title = "Change Advisory Board Workflows Component 4",
  onItemSelect
}) => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedStatus, setSelectedStatus] = useState<string>('ALL');

  const mockData: ChangeRequestItem4[] = [
    { id: 101, code: "CHA-4-001", name: "Change Advisory Board Workflows Record A", category: "ENTERPRISE", status: "ACTIVE", priority: "HIGH", created_at: "2026-09-01T10:00:00Z" },
    { id: 102, code: "CHA-4-002", name: "Change Advisory Board Workflows Record B", category: "STANDARD", status: "PENDING", priority: "MEDIUM", created_at: "2026-09-02T14:30:00Z" },
    { id: 103, code: "CHA-4-003", name: "Change Advisory Board Workflows Record C", category: "CRITICAL", status: "IN_REVIEW", priority: "CRITICAL", created_at: "2026-09-03T09:15:00Z" }
  ];
