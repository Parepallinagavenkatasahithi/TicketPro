...
class OnCallRosterProcessorModule27:
    """
    24/7 on-call schedules, override management, escalation rotas, and shift handover notes - Module 27.
    ...
    def execute_workflow_step_27(self, entity_id: int, payload: Dict[str, Any], context_user_id: int) -> Dict[str, Any]:
        ...
        step_code = f"WF-ONCALLROSTER-27-{entity_id}"
